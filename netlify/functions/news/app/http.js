...
/* Assets live at the repo root so the CDN can serve them directly; the local
   dev server still serves them through here. */
const PUBLIC_DIR = process.env.NEWS_ASSET_DIR
  ? resolve(process.env.NEWS_ASSET_DIR) + '/'
  : fileURLToPath(new URL('../../../../news-assets/', import.meta.url));
